...
export async function giftCode(msg) {
    try {
        ...
        if (checkUser.isJoined === true) {
            ...
            const photo = 'https://i.ibb.co/bFfxkBP/IMG.jpg';
